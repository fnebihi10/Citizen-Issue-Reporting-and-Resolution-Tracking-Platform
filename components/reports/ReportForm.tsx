...
export function ReportForm({ categories }: { categories: Category[] }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6" noValidate>
      ...
      <div className="flex gap-3 rounded-2xl border border-blue-100 bg-blue-50/70 px-4 py-3.5 text-sm leading-6 text-blue-950"><Info className="mt-0.5 h-5 w-5 shrink-0 text-blue-700" aria-hidden="true" /><p><strong>Privatësia:</strong> emri, email-i, fotografia dhe lokacioni i saktë nuk publikohen në hartën publike. Për emergjenca telefono <a href="tel:112" className="font-black underline decoration-2 underline-offset-2">112</a>; kjo platformë trajton vetëm çështje jo-emergjente.</p></div>
